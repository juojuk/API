...
namespace API_mokymai.Data
{
    public static class ReservationSet
    {
        public static List<Reservation> reservationList = new List<Reservation>()
        {
            ...
            new Reservation(2, new DateTime(2020, 2, 1), null, 2, 1, 1),
            new Reservation(3, new DateTime(2020, 3, 1), null, 2, 1, 1),
            new Reservation(4, new DateTime(2020, 4, 1), null, 2, 1, 1),
            new Reservation(5, new DateTime(2020, 5, 1), null, 2, 1, 1),
