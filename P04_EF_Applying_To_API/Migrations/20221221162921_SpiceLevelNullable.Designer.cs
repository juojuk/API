...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221221162921_SpiceLevelNullable")]
    partial class SpiceLevelNullable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 21, 18, 29, 21, 184, DateTimeKind.Local).AddTicks(6406),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 21, 18, 29, 21, 184, DateTimeKind.Local).AddTicks(6552),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 21, 18, 29, 21, 184, DateTimeKind.Local).AddTicks(6605),
                            ImagePath = "1",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
