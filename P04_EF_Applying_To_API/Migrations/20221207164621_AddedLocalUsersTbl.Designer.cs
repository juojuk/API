...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221207164621_AddedLocalUsersTbl")]
    partial class AddedLocalUsersTbl
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 20, 732, DateTimeKind.Local).AddTicks(1410),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 20, 732, DateTimeKind.Local).AddTicks(1586),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 7, 18, 46, 20, 732, DateTimeKind.Local).AddTicks(1667),
                            ImagePath = "1",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
