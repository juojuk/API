...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221208175855_ModifyLocalUser")]
    partial class ModifyLocalUser
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 58, 55, 682, DateTimeKind.Local).AddTicks(1311),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 58, 55, 682, DateTimeKind.Local).AddTicks(1543),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 8, 19, 58, 55, 682, DateTimeKind.Local).AddTicks(1649),
                            ImagePath = "1",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
