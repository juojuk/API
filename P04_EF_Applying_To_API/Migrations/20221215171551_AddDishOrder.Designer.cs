...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221215171551_AddDishOrder")]
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 15, 19, 15, 50, 725, DateTimeKind.Local).AddTicks(5871),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 15, 19, 15, 50, 725, DateTimeKind.Local).AddTicks(6022),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 12, 15, 19, 15, 50, 725, DateTimeKind.Local).AddTicks(6075),
                            ImagePath = "1",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food",
