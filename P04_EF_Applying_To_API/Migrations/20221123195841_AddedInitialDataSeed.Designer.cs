...
namespace P04EFApplyingToAPI.Migrations
{
    ...
    [Migration("20221123195841_AddedInitialDataSeed")]
            ...
            modelBuilder.Entity("P04_EF_Applying_To_API.Models.Dish", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            DishId = 1,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 23, 21, 58, 40, 952, DateTimeKind.Local).AddTicks(2101),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 2,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 23, 21, 58, 40, 952, DateTimeKind.Local).AddTicks(2252),
                            ImagePath = "1",
                        ...
                        new
                        {
                            DishId = 3,
                            Country = "Lithuanian",
                            CreateDateTime = new DateTime(2022, 11, 23, 21, 58, 40, 952, DateTimeKind.Local).AddTicks(2484),
                            ImagePath = "1",
                            Name = "Kibinai",
                            SpiceLevel = "Low",
                            Type = "Street food"
